...
/*This is an added librety not written by the student, it was added only as a fix 
for the flickering and nothing more. the rest of the application is the student, Yahav
Sharabi, work.
*/
